# ASTRX Price and Dividend Analysis
# SMM265 Asset Pricing - Question 1
...
def load_and_clean_data():
    ...
    """
    # File path
    file_path = r"C:\Users\Manpreet\OneDrive - City St George's, University of London\Documents\Term1\Coursework\SMM265 Asset Pricing\Q1\Data\Raw Data\Monthly\SMM265 - ASTRX - FTSE All Share Index - Monthly with Dividend Yield.xlsx"
...
def save_cleaned_data(df, output_path=None):
    ...
    if output_path is None:
        ...
        output_path = os.path.join(output_dir, "SMM265_Index_DivYield_Monthly.xlsx")
...
def main():
    ...
    """
    print("ASTRX Index and Dividend Analysis")
    print("=" * 40)
