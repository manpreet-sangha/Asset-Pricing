...
def process_interbank_rate_data():
    """
    Simple processing of UK 3 Month InterBank rate data (Quarterly):
    ...
    input_file = BASE_PATH / "Data" / "Cleaned Data" / "Quarterly" / "SMM265 - UK Quarterly InterBank rate.xlsx"
    output_dir = BASE_PATH / "Data" / "Cleaned Data" / "Quarterly"
    output_dir.mkdir(parents=True, exist_ok=True)
    output_file = output_dir / "SMM265_UK_Quarterly_InterBank_Rate.xlsx"
