...
def load_and_clean_data():
    """
    Load and clean the UK Treasury Bill data from Excel file
    """
    # File path
    file_path = r"C:\Users\Manpreet\OneDrive - City St George's, University of London\Documents\Term1\Coursework\SMM265 Asset Pricing\Q1\Data\Raw Data\Monthly\SMM265 - 1126593 Index - IMF UK Treasury Bill 3 Month Rate- Monthly.xlsx"
    ...
    try:
        ...
        # Rename columns to 'Date' and 'uktb_yield'
        if len(df_cleaned.columns) >= 2:
            df_cleaned.columns = ['Date', 'uktb_yield']
...
def save_cleaned_data(df, output_path=None):
    ...
    if output_path is None:
        ...
        output_path = os.path.join(output_dir, "SMM265 - 1126593 Index - IMF UK Treasury Bill 3 Month Rate- Monthly.xlsx")
...
def main():
    """
    Main function for UK Treasury Bill analysis
    """
    print("UK Treasury Bill Analysis")
    print("=" * 40)
