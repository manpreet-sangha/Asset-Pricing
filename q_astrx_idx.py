# ASTRX Index Analysis - Quarterly Data
...
def load_and_clean_data():
    ...
    """
    # File path
    file_path = r"C:\Users\Manpreet\OneDrive - City St George's, University of London\Documents\Term1\Coursework\SMM265 Asset Pricing\Q1\Data\Raw Data\Quarterly\SMM265 - ASTRX - FTSE All Share Index - Quarterly.xlsx"
...
def save_cleaned_data(df, output_path=None):
    ...
    if output_path is None:
        ...
        output_path = os.path.join(output_dir, "SMM265 - ASTRX - FTSE All Share Index - Quarterly.xlsx")
...
def main():
    ...
    """
    print("ASTRX Index Analysis - Quarterly")
    print("=" * 40)
