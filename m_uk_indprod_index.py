# UK Industrial Production Index Analysis
# SMM265 Asset Pricing - Monthly Data
# Author: [210048348 - Manpreet Sangha]
...
def load_and_clean_data():
    """
    Load and clean the UK Industrial Production Index data from Excel file
    """
    # File path
    file_path = r"C:\Users\Manpreet\OneDrive - City St George's, University of London\Documents\Term1\Coursework\SMM265 Asset Pricing\Q1\Data\Raw Data\Monthly\SMM265 - UKIPIYOY Index - UK IP YoY - Monthly.xlsx"
    ...
    try:
        ...
        # Load the Excel file
        print("Loading UK Industrial Production Index Excel file...")
        ...
        print("\n" + "="*50)
        print("CLEANING UK INDUSTRIAL PRODUCTION INDEX DATA")
        print("="*50)
        ...
        # Rename columns to 'date' and 'ukipiyoy_index'
        if len(df_cleaned.columns) >= 2:
            df_cleaned.columns = ['date', 'ukipiyoy_index']
        ...
        print(f"Error loading/cleaning UK Industrial Production Index data: {e}")
        return None

def save_cleaned_data(df, output_path=None):
    """
    Save cleaned UK Industrial Production Index data to Excel file
    """
    if df is None:
    ...
    if output_path is None:
        ...
        output_path = os.path.join(output_dir, "SMM265 - UKIPIYOY Index - UK IP YoY - Monthly.xlsx")
    
    try:
        df.to_excel(output_path, index=False)
        print(f"\nCleaned UK Industrial Production Index data saved to: {output_path}")
    except Exception as e:
        print(f"Error saving UK Industrial Production Index data: {e}")

def main():
    """
    Main function for UK Industrial Production Index analysis
    """
    print("UK Industrial Production Index Analysis")
    print("=" * 40)
